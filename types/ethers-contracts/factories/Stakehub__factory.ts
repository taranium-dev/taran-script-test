...
import type { Stakehub, StakehubInterface } from "../Stakehub";
...
export class Stakehub__factory {
  static readonly abi = _abi;
  static createInterface(): StakehubInterface {
    return new Interface(_abi) as StakehubInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): Stakehub {
    return new Contract(address, _abi, runner) as unknown as Stakehub;
  }
}
