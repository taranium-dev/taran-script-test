...
import type {
  Bscvalidatorset,
  BscvalidatorsetInterface,
} from "../Bscvalidatorset";
...
export class Bscvalidatorset__factory {
  static readonly abi = _abi;
  static createInterface(): BscvalidatorsetInterface {
    return new Interface(_abi) as BscvalidatorsetInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): Bscvalidatorset {
    return new Contract(address, _abi, runner) as unknown as Bscvalidatorset;
  }
}
